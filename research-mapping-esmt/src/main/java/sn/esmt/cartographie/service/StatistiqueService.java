...
public class StatistiqueService {
        ...
        public StatisticsDTO getStatistics() {
                ...
                Map<String, Long> projetsParStatut = projets.stream()
                                ...
                                .collect(Collectors.groupingBy(p -> p.getStatut_projet().toString(),
                                                Collectors.counting()));
                ...
                Map<String, Long> projetsParDomaine = projets.stream()
                                ...
                                .collect(Collectors.groupingBy(p -> p.getDomaine_recherche().getNomDomaine(),
                                                Collectors.counting()));
                ...
                // Evolution temporelle (nombre de projets par année de début)
                Map<Integer, Long> evolutionTemporelle = new TreeMap<>();
                for (Projet p : projets) {
                        if (p.getDate_debut() != null) {
                                Calendar cal = Calendar.getInstance();
                                cal.setTime(p.getDate_debut());
                                int year = cal.get(Calendar.YEAR);
                                evolutionTemporelle.merge(year, 1L, Long::sum);
                        }
                }
                stats.setEvolutionTemporelle(evolutionTemporelle);
         ...
         * 
         * @return Map avec le nom du domaine comme clé et le nombre de projets comme
         *         valeur
         */
         ...
         * 
         * @return Map avec le nom du participant comme clé et le nombre de projets
         *         comme valeur
         */
        ...
        /**
         * Compte le nombre de projets démarrés par année
         * 
         * @return Map avec l'année comme clé et le nombre de projets comme valeur
         */
        public Map<Integer, Long> compterProjetsParAnnee() {
                ...
                for (Projet p : projetRepository.findAll()) {
                        if (p.getDate_debut() != null) {
                                ...
                                cal.setTime(p.getDate_debut());
                                int year = cal.get(Calendar.YEAR);
                                evolution.merge(year, 1L, Long::sum);
                        }
                }
                return evolution;
        }
